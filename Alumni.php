...
<!-- MAIN CONTENT STARTS -->
<span class="bgtext"> Alumni </span>

<div class="col-md-12">
<a href="#">
<span  class="Mj-btn" style="margin-top:20px;margin-right:-10px;"><button class="Mj-cls"><b>LOGIN</b></button></span>
</a>
<p style="font-family:Titillium Web;font-size:55px;"><b>Our Alumnies</b></p>
...
<div class="container-fluid">
 <div  id="f" style="background-image:url('images/0.jpeg');height:1000px;" class="jumbotron">
<h1 align="center">Alumni News</h1><br>
   
  
 <p> <font color="white">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</font></p>
  <center> 
